 ...
 */
final class Version20240508110607 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, categorie_id INT DEFAULT NULL, prix DOUBLE PRECISION DEFAULT NULL, emplacement VARCHAR(255) DEFAULT NULL, choisi TINYINT(1) DEFAULT NULL, INDEX IDX_97A0ADA3BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
